...
// LED控制宏定义（低电平点亮）
#define LED_ON()    HAL_GPIO_WritePin(IO_LED_GPIO_Port, IO_LED_Pin, GPIO_PIN_RESET)
#define LED_OFF()   HAL_GPIO_WritePin(IO_LED_GPIO_Port, IO_LED_Pin, GPIO_PIN_SET)
#define LED_TOGGLE() HAL_GPIO_TogglePin(IO_LED_GPIO_Port, IO_LED_Pin)
